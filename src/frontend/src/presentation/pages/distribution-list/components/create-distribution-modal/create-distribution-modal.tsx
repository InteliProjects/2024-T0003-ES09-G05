...
import Styles from "./create-distribution-modal.module.scss";
...
const CreateDistributionModal: React.FC<Props> = ({ data, close }: Props) => {
  const [channel, setChannel] = useState(data.defaultValue);
        ...
        <div className={Styles.upload}>
          ...
          >
            <div className={Styles.container}>
              ...
              <p>
                Apenas documentos com no máximo 5mb, no formato .csv ou
                .xlsx
              </p>
